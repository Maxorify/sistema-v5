              ...
              <div className="card-body">
                ...
                <div className="event border-bottom py-3">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="image-grouped ml-auto mt-2 mt-xl-0">
                      <img src={getImageUrl('faces/face10.jpg')} alt="profile" />
                      <img src={getImageUrl('faces/face13.jpg')} alt="profile" /> </div>
                  </div>
                </div>
                <div className="event py-3 border-bottom">
                  ...
                  <div className="d-flex  align-items-center">
                    ...
                    <div className="image-grouped ml-auto mt-2 mt-xl-0">
                      <img src={getImageUrl('faces/face20.jpg')} alt="profile "/>
                      <img src={getImageUrl('faces/face17.jpg')} alt="profile "/>
                      <img src={getImageUrl('faces/face14.jpg')} alt="profile " /> </div>
                  </div>
                </div>
                <div className="event py-3">
                  ...
                  <div className="d-flex  align-items-center">
                    ...
                    <div className="image-grouped ml-auto mt-2 mt-xl-0">
                      <img src={getImageUrl('faces/face21.jpg')} alt="profile"/>
                      <img src={getImageUrl('faces/face16.jpg')} alt="profile" /> </div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="fluid-container">
                  <div className="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                    <div className="col-md-1">
                      <img className="img-sm rounded-circle mb-4 mb-md-0 d-block mx-md-auto" src={getImageUrl('faces/face1.jpg')} alt="profile" /> </div>
                  ...
                  <div className="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                    <div className="col-md-1">
                      <img className="img-sm rounded-circle mb-4 mb-md-0 d-block mx-md-auto" src={getImageUrl('faces/face2.jpg')} alt="profile" /> </div>
                    <div className="ticket-details col-md-9">
                      <div className="d-lg-flex">
                  ...
                  <div className="row ticket-card mt-3">
                    <div className="col-md-1">
                      <img className="img-sm rounded-circle mb-4 mb-md-0 d-block mx-md-auto" src={getImageUrl('faces/face3.jpg')} alt="profile" /> </div>
                    <div className="ticket-details col-md-9">
                      <div className="d-lg-flex">
